describe('Dataset', function() {
  ...
  describe('#update', function() {
    ...
    it('should render header when suggestions are rendered', function() {
      ...
      expect(this.dataset.$el).toContainText('templates.back.header');
    });
    ...
    it('should not render header/footer if there is no content', function() {
      ...
      expect(this.dataset.$el).not.toContainText('templates.back.header');
      expect(this.dataset.$el).not.toContainText('templates.back.footer');
    });
